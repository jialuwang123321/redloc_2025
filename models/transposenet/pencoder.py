...
import torchvision
# print('\n\n float(torchvision.__version__[:10]) = ',float(torchvision.__version__[:10]))
print('\n\n float(torchvision.__version__[:3]) = ',float(torchvision.__version__[:3]))
...
class PositionEmbeddingLearnedWithPoseToken(nn.Module):
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        # print('before PositionEmbeddingLearnedWithPoseToken, x.shape =', x.shape)# x.shape = torch.Size([8, 112, 14, 14])
        # pdb.set_trace()
        h, w = x.shape[-2:]
