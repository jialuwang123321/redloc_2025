    ...
    if args.mode == 'train':
        ...
        for epoch in range(n_epochs):
            ...
            if (epoch % n_freq_checkpoint) == 0 and epoch > 0:
                ...
                if args.use_mamba:
                    if args.scene in ['OldHospital', 'KingsCollege', 'ShopFacade', 'AtMarysChurch']:
                        command = f"python main_posenet.py {args.model_name} test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/Cambridge /home/transposenet/datasets123/CambridgeLandmarks/abs_cambridge_pose_sorted.csv_{args.scene}_test.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim}" #/home/transposenet/out/{checkpoint_prefix}_checkpoint-{epoch}.pth"
                    else: 
                        command = f"python main_posenet.py {args.model_name} test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/7Scenes /home/transposenet/datasets123/7Scenes/abs_7scenes_pose.csv_{args.scene}_test.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim}" 
                else:
                    if args.scene in ['GreatCourt', 'KingsCollege', 'ShopFacade', 'AtMarysChurch']:
                        command = f"python main_posenet.py {args.model_name} test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/Cambridge /home/transposenet/datasets123/CambridgeLandmarks/abs_cambridge_pose_sorted.csv_{args.scene}_test.csv --checkpoint_path {weights_filename} --scene {args.scene} --skipvim {args.skipvim}" #/home/transposenet/out/{checkpoint_prefix}_checkpoint-{epoch}.pth"
                    else: 
                        command = f"python main_posenet.py {args.model_name} test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/7Scenes /home/transposenet/datasets123/7Scenes/abs_7scenes_pose.csv_{args.scene}_test.csv --checkpoint_path {weights_filename} --scene {args.scene} --skipvim {args.skipvim}" 
        ...
        pose_stats_file = '/home/transposenet/data/7Scenes/heads/pose_stats.txt'
        ...
        if args.use_mamba:
            image_filename = f'/home/Visualizetrajectories/Transposenet_2D/{filename_without_extension}_2dmap.png' 
        else:
            image_filename = f'/home/Visualizetrajectories/Transposenet_2D/{filename_without_extension}_2dmap.png' 
        ...
        # # image_filename = '/home/Visualizetrajectories/Transposenet_2D/transposenet_2dmap.png'
        # fig.savefig(image_filename)
        ...
        if args.use_mamba:
            results_filename = f'results_posenet_mamba_{args.scene}_skip_{args.skipvim}.txt'
        else:
            results_filename = f'results_posenet_{args.scene}_skip_{args.skipvim}.txt'
