...
if __name__ == "__main__":
    ...
    if args.mode == 'train':
        ...
        print('args.results_type = ',args.results_type)
        ...
        if multiscene:
            ...
            dataset = CameraPoseDataset_anyloc(args.dataset_path, args.labels_file, transform, args.skipvim, args.tab, results_type=args.results_type, scene=args.scene)
                    ...
                    if args.use_mamba:
                        ...
                        if args.use_classical_mamba:
                            if args.scene in ['OldHospital', 'KingsCollege', 'ShopFacade', 'StMarysChurch']:
                                command = f"python main_anyloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/Cambridge /home/transposenet/datasets123/CambridgeLandmarks/abs_cambridge_pose_sorted.csv_{args.scene}_test_hard01.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim} --use_classical_mamba True --current_epoch {epoch} --pick_saved_epoch True --results_type 1 --scene {args.scene}" #/home/transposenet/out/{checkpoint_prefix}_checkpoint-{epoch}.pth"
                            else: 
                                command = f"python main_anyloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/7Scenes /home/transposenet/datasets123/7Scenes/abs_7scenes_pose.csv_{args.scene}_test_hard01.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim} --use_classical_mamba True --current_epoch {epoch} --pick_saved_epoch True --results_type 1 --scene {args.scene}" 
                        else:
                            if args.scene in ['OldHospital', 'KingsCollege', 'ShopFacade', 'StMarysChurch']:
                                command = f"python main_anyloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/Cambridge /home/transposenet/datasets123/CambridgeLandmarks/abs_cambridge_pose_sorted.csv_{args.scene}_test_hard01.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim} --current_epoch {epoch} --pick_saved_epoch True --results_type 1 --scene {args.scene}" #/home/transposenet/out/{checkpoint_prefix}_checkpoint-{epoch}.pth"
                            else: 
                                command = f"python main_anyloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/7Scenes /home/transposenet/datasets123/7Scenes/abs_7scenes_pose.csv_{args.scene}_test_hard01.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim} --current_epoch {epoch} --pick_saved_epoch True --results_type 1 --scene {args.scene}" 
                        ...
                        if args.scene in ['OldHospital', 'KingsCollege', 'ShopFacade', 'StMarysChurch']:
                            ...
                            command = f"python main_anyloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/7Scenes /home/transposenet/datasets123/7Scenes/abs_7scenes_pose.csv_{args.scene}_test_hard01.csv --checkpoint_path {weights_filename} --scene {args.scene} --skipvim {args.skipvim} --current_epoch {epoch} --pick_saved_epoch True --results_type 1 --scene {args.scene}" 
                ...
                if test_at_good:
                    ...
                    if args.use_mamba:
                        ...
                        if args.use_classical_mamba:
                            ...
                            if args.scene in ['OldHospital', 'KingsCollege', 'ShopFacade', 'StMarysChurch']:
                                command = f"python main_anyloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/Cambridge /home/transposenet/datasets123/CambridgeLandmarks/abs_cambridge_pose_sorted.csv_{args.scene}_test.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim} --current_epoch {epoch} --results_type 2 --scene {args.scene}" #/home/transposenet/out/{checkpoint_prefix}_checkpoint-{epoch}.pth"
                            else: 
                                command = f"python main_anyloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/7Scenes /home/transposenet/datasets123/7Scenes/abs_7scenes_pose.csv_{args.scene}_test.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim} --current_epoch {epoch} --results_type 2 --scene {args.scene}" 
                        ...
                        if args.scene in ['OldHospital', 'KingsCollege', 'ShopFacade', 'StMarysChurch']:
                            ...
                            command = f"python main_anyloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/7Scenes /home/transposenet/datasets123/7Scenes/abs_7scenes_pose.csv_{args.scene}_test.csv --checkpoint_path {weights_filename} --scene {args.scene} --skipvim {args.skipvim} --current_epoch {epoch} --results_type 2 --scene {args.scene}" 
        ...
        if multiscene:
            ...
            dataset = CameraPoseDataset_anyloc(args.dataset_path, args.labels_file, transform, results_type=args.results_type, scene=args.scene)
