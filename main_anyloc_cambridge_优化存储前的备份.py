...
import time
from transposenet.datasets123.CameraPoseDataset_anyloc_cambridge import CameraPoseDataset_anyloc_cambridge
...
if __name__ == "__main__":
    ...
    if args.mode == 'train':
        ...
        if multiscene:
            ...
            dataset = CameraPoseDataset_anyloc_cambridge(args.dataset_path, args.labels_file, transform, args.skipvim, args.tab, scene=args.scene)
        ...
        if multiscene:
            ...
            dataset = CameraPoseDataset_anyloc_cambridge(args.dataset_path, args.labels_file, transform, scene=args.scene)
        if args.use_mamba:
