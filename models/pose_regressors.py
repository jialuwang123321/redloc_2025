...
from .transposenet.TransPoseNet_mamba import TransPoseNet_mamba
...
def get_model(model_name, backbone_path,use_mamba:False,config,return_feature=False, return_feature_plot =False,use_classical_mamba=False):
    ...
    if model_name == 'posenet':
        ...
        if use_mamba:
            ...
            return TransPoseNet_mamba(config, backbone_path,return_feature=return_feature, return_feature_plot = return_feature_plot,use_classical_mamba=use_classical_mamba)
        else:
            return TransPoseNet(config, backbone_path,return_feature=return_feature)
    else:
