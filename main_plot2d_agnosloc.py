...
import time
from datasets123.CameraPoseDataset_anyloc_cambridge import CameraPoseDataset_anyloc_cambridge as CameraPoseDataset
...
if __name__ == "__main__":
    ...
    if args.mode == 'train':
            ...
            if (epoch % n_freq_checkpoint) == 0 and epoch > 10:
                ...
                if args.use_mamba:
                    if args.scene in ['OldHospital', 'KingsCollege', 'ShopFacade', 'StMarysChurch']:
                        command = f"python main_plot2d_agnosloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/Cambridge /home/transposenet/datasets123/CambridgeLandmarks/abs_cambridge_pose_sorted.csv_{args.scene}_test_hard01.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim} --results_type 1" #/home/transposenet/out/{checkpoint_prefix}_checkpoint-{epoch}.pth"
                    else: 
                        command = f"python main_plot2d_agnosloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/7Scenes /home/transposenet/datasets123/7Scenes/abs_7scenes_pose.csv_{args.scene}_test_hard01.csv --checkpoint_path {weights_filename} --use_mamba True --scene {args.scene} --skipvim {args.skipvim} --results_type 1" 
                else:
                    if args.scene in ['OldHospital', 'KingsCollege', 'ShopFacade', 'StMarysChurch']:
                        command = f"python main_plot2d_agnosloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/Cambridge /home/transposenet/datasets123/CambridgeLandmarks/abs_cambridge_pose_sorted.csv_{args.scene}_test_hard01.csv --checkpoint_path {weights_filename} --scene {args.scene} --skipvim {args.skipvim} --results_type 1" #/home/transposenet/out/{checkpoint_prefix}_checkpoint-{epoch}.pth"
                    else: 
                        command = f"python main_plot2d_agnosloc.py transposenet test ./models/backbones/efficient-net-b0.pth /home/transposenet/data/7Scenes /home/transposenet/datasets123/7Scenes/abs_7scenes_pose.csv_{args.scene}_test_hard01.csv --checkpoint_path {weights_filename} --scene {args.scene} --skipvim {args.skipvim} --results_type 1" 
        ...
        if multiscene:
            ...
            dataset = CameraPoseDataset(args.dataset_path, args.labels_file, transform, scene=args.scene, results_type=args.results_type)
        if args.use_mamba:
